                ...
                <div className="space-y-6 p-6 rounded-xl bg-gray-900/50 border border-[var(--bold-red)]/20">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-reverse space-x-3">
                      ...
                      <span className="text-[var(--ice-white)]/80">info@tekpooshkhaas.com</span>
                    </div>
                    <div className="flex items-center space-x-reverse space-x-3">
                      <div className="w-6 h-6 flex items-center justify-center">
                        <svg className="w-4 h-4 text-[var(--bold-red)]" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <span className="text-[var(--ice-white)]/80">۰۹۱۲۳۴۵۶۷۸۹</span>
                    </div>
                    <div className="flex items-center space-x-reverse space-x-3">
                      <div className="w-6 h-6 flex items-center justify-center">
                        <svg className="w-4 h-4 text-[var(--bold-red)]" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <span className="text-[var(--ice-white)]/80">تهران، ایران</span>
                    </div>
                  </div>
                </div>
              </div>
