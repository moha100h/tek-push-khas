        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mb-8">
              <h2 className="text-3xl md:text-4xl font-bold text-[var(--ice-white)] mb-3 neon-text">
                {aboutContent?.title || "درباره تک پوش خاص"}
              </h2>
              <p className="text-base md:text-lg text-[var(--ice-white)]/80 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8">
              {/* Philosophy Section */}
              <div className="p-6 rounded-xl bg-gray-900/40 border border-[var(--bold-red)]/20 backdrop-blur-sm">
                <h3 className="text-xl md:text-2xl font-bold text-[var(--bold-red)] mb-4 neon-text">
                  {aboutContent?.philosophyTitle || "فلسفه ما"}
                </h3>
                <div className="space-y-3">
                  <p className="text-[var(--ice-white)] leading-relaxed text-sm md:text-base">
              ...
              <div className="p-6 rounded-xl bg-gray-900/40 border border-[var(--bold-red)]/20 backdrop-blur-sm">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-reverse space-x-3">
                    ...
                    <span className="text-[var(--ice-white)] text-sm md:text-base">
                      {aboutContent?.contactEmail || "info@tekpooshkhaas.com"}
                    </span>
                  </div>
                  <div className="flex items-center space-x-reverse space-x-3">
                    <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                    ...
                    <span className="text-[var(--ice-white)] text-sm md:text-base">
                      {aboutContent?.contactPhone || "۰۹۱۲۳۴۵۶۷۸۹"}
                    </span>
                  </div>
                  <div className="flex items-center space-x-reverse space-x-3">
                    <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                    ...
                    <span className="text-[var(--ice-white)] text-sm md:text-base">
                      {aboutContent?.contactAddress || "تهران، ایران"}
                    </span>
                  </div>
                </div>
              </div>
