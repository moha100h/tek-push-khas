    ...
    <>
      <header className={`sticky top-0 z-50 transition-all duration-500 ${
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <div className="h-px bg-gradient-to-r from-transparent via-[var(--ice-white)]/60 to-transparent"></div>
          <div className="h-px bg-gradient-to-r from-transparent via-white/20 to-transparent mt-px"></div>
        </div>
